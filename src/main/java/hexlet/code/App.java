...
По первому замечанию, все вызовы кроме самого первого, где просто приветствие, перенес в игры. Первый пункт это
формально не игра, но делать под нее отдельный класс вроде бы как-то неправильно. Но тогда остается вызов одного метода
из движка.
